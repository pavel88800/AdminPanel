...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APP.DB.Models.Boards", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("APP.DB.Models.Card", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("Limitation")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("APP.DB.Models.Column", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("APP.DB.Models.Task", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("APP.DB.Models.Card", b =>
                {
                    b.HasOne("APP.DB.Models.Column", "Column")
                        .WithMany()
            ...
            modelBuilder.Entity("APP.DB.Models.Column", b =>
                {
                    b.HasOne("APP.DB.Models.Boards", "Board")
                        .WithMany()
            ...
            modelBuilder.Entity("APP.DB.Models.Task", b =>
                {
                    b.HasOne("APP.DB.Models.Card", "Card")
                        .WithMany("CheckList")
            ...
            modelBuilder.Entity("APP.DB.Models.User", b =>
                {
                    b.HasOne("APP.DB.Models.Card", null)
                        .WithMany("Users")
                        .HasForeignKey("CardId");
